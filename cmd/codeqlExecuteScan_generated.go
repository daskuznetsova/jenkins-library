...
func addCodeqlExecuteScanFlags(cmd *cobra.Command, stepConfig *codeqlExecuteScanOptions) {
	...
	cmd.Flags().StringSliceVar(&stepConfig.CustomCommand, "customCommand", []string{}, "A custom user-defined commands to run between codeql analysis and results upload.")
